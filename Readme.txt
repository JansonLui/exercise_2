...
2. sudo lein run -m streamparse.commands.run/-main topologies/tweetwordcount.clj -t 120 --option 'topology.workers=2' --option 'topology.acker.executors=2' --option 'streamparse.log.path=/<path to source>/EX2Tweetwordcount/logs' --option 'streamparse.log.level="debug"'
...
the (streamparse.log.path="/<pathtosource>/EX2Tweetwordcount/logs") has quotes around it, 
